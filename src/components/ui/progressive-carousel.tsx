  ...
  useEffect(() => {
    ...
    if (getChildren) {
      const values = React.Children.toArray(
        (getChildren as React.ReactElement<any>).props.children
  ...
  return (
    ...
    >
      ...
      <div
        ...
        role='progressbar'
        aria-label="Progress"
        aria-valuenow={Math.round(active === value ? progress : 0)}
        aria-valuemin={0}
        aria-valuemax={100}
      >
        <span
          className={cn('absolute left-0 bottom-0', progressBarClass)}
          style={{
